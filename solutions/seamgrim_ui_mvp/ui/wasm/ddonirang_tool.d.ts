...
export interface InitOutput {
    ...
    readonly ddnwasmvm_columns: (a: number) => any;
    readonly ddnwasmvm_get_build_info: (a: number) => [number, number];
    readonly ddnwasmvm_get_state_hash: (a: number) => [number, number];
    readonly ddnwasmvm_get_state_json: (a: number) => any;
    readonly ddnwasmvm_inject_ai_action: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly ddnwasmvm_new: (a: number, b: number) => [number, number, number];
    readonly ddnwasmvm_new_with_mode: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly ddnwasmvm_reset: (a: number, b: number) => [number, number, number];
    readonly ddnwasmvm_restore_state: (a: number, b: number, c: number) => [number, number, number];
    ...
    readonly ddnwasmvm_set_param: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly ddnwasmvm_set_param_fixed64: (a: number, b: number, c: number, d: bigint) => [number, number, number];
    readonly ddnwasmvm_set_param_fixed64_str: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly ddnwasmvm_set_pointer: (a: number, b: number, c: number) => void;
    readonly ddnwasmvm_set_rng_seed: (a: number, b: bigint) => void;
    readonly ddnwasmvm_step_one: (a: number) => [number, number, number];
    readonly ddnwasmvm_step_one_with_input: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly ddnwasmvm_update_logic: (a: number, b: number, c: number) => [number, number];
    readonly ddnwasmvm_update_logic_with_mode: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly wasm_build_info: () => [number, number];
    readonly wasm_preprocess_source: (a: number, b: number) => [number, number, number, number];
