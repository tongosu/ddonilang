...
This pack closes `STUDIO_NEXT_ROADMAP_V2_COORDINATE_LOCK_V1` with product UI behavior evidence.

It records the next ROADMAP_V2 coordinate lock evidence:

- schema: `ddn.studio.next_roadmap_v2_coordinate_lock.v1`
- source benchmark baseline prep dry run: `pack/studio_benchmark_baseline_prep_dry_run_v1/benchmark_baseline_prep_dry_run.detjson`
- source post-super-long rebase: `pack/studio_post_super_long_rebase_v1/post_super_long_rebase.detjson`
- coordinate decisions: 5
- selected default coordinate: `마-3`
