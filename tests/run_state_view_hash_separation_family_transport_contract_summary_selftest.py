...
from run_state_view_hash_separation_family_transport_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[state-view-hash-separation-family-transport-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[state-view-hash-separation-family-transport-contract-summary-selftest] ok")
    return 0
