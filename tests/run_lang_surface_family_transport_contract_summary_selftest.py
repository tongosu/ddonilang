...
from run_lang_surface_family_transport_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[lang-surface-family-transport-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[lang-surface-family-transport-contract-summary-selftest] ok")
    return 0
