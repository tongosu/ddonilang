...
from run_seamgrim_assurance_family_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-assurance-family-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-assurance-family-contract-summary-selftest] ok")
    return 0
