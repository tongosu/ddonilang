...
SCRIPT_TAG = "seamgrim-surface-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_SURFACE_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("seamgrim_surface_family", "tests/run_seamgrim_surface_family_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_surface_family_contract_selftest.progress.v1",
