...
def main() -> int:
    ...
    if not bool(payload.get("ok")):
        print(
            "check=seamgrim_generic_imja_queue_fifo_raw_wasm "
    ...
    if not str(payload.get("state_hash", "")).strip():
        print("check=seamgrim_generic_imja_queue_fifo_raw_wasm detail=missing_hash")
        return 1
    ...
    if seq != "12345":
        ...
        return 1
    print("seamgrim generic imja queue fifo raw wasm check ok seq=12345")
    return 0
