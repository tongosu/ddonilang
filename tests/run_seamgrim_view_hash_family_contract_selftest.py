...
SCRIPT_TAG = "seamgrim-view-hash-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_VIEW_HASH_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    (
    ...
    ("seamgrim_view_hash_family", [sys.executable, "tests/run_seamgrim_view_hash_family_selftest.py"]),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_view_hash_family_contract_selftest.progress.v1",
