...
from run_seamgrim_bridge_family_transport_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-bridge-family-transport-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-bridge-family-transport-contract-summary-selftest] ok")
    return 0
