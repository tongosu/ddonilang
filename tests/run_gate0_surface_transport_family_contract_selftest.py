...
SCRIPT_TAG = "gate0-surface-transport-family-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_gate0_surface_transport_family_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_GATE0_SURFACE_TRANSPORT_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("lang_surface_family_transport", "tests/run_lang_surface_family_transport_contract_selftest.py"),
    ("lang_runtime_family_transport", "tests/run_lang_runtime_family_transport_contract_selftest.py"),
    ("gate0_runtime_family_transport", "tests/run_gate0_runtime_family_transport_contract_selftest.py"),
