...
README_PATH = Path("tests/seamgrim_delivery_family/README.md")
APPLICATION_README = Path("tests/seamgrim_application_family/README.md")
...
def fail(message: str) -> int:
    print(f"[seamgrim-delivery-family-selftest] fail: {message}")
    return 1
...
def main() -> int:
    try:
        ...
        ensure_pointers(APPLICATION_README)
        ensure_pointers(RUNTIME_README)
        ensure_snippets(
            SEAMGRIM_GATE,
            (
                '"seamgrim_delivery_family_selftest"',
                '[py, "tests/run_seamgrim_delivery_family_selftest.py"]',
                '"seamgrim_delivery_family_contract_selftest"',
                '[py, "tests/run_seamgrim_delivery_family_contract_selftest.py"]',
                '"seamgrim_delivery_family_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_delivery_family_contract_summary_selftest.py"]',
                '"seamgrim_delivery_family_transport_contract_selftest"',
                '[py, "tests/run_seamgrim_delivery_family_transport_contract_selftest.py"]',
                '"seamgrim_delivery_family_transport_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_delivery_family_transport_contract_summary_selftest.py"]',
            ),
        )
    except ValueError as exc:
        return fail(str(exc))
    print("[seamgrim-delivery-family-selftest] ok lines=2")
    return 0
