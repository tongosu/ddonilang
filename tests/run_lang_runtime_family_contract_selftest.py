...
SCRIPT_TAG = "lang-runtime-family-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_lang_runtime_family_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_LANG_RUNTIME_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
ROOT = Path(__file__).resolve().parents[1]
CHECKS = (
    ("lang_surface_family", "tests/run_lang_surface_family_selftest.py"),
    ("stdlib_catalog", "tests/run_stdlib_catalog_check_selftest.py"),
    ("tensor_pack", "tests/run_tensor_v0_pack_check.py"),
    ("tensor_cli", "tests/run_tensor_v0_cli_check.py"),
    ("lang_runtime_family", "tests/run_lang_runtime_family_selftest.py"),
)
