...
def fail(msg: str) -> int:
    print(f"[ci-aggregate-age5-child-summary-gate0-transport-family-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(
        prefix="ci_aggregate_age5_child_summary_gate0_transport_family_selftest_"
    ) as tmp:
        work = Path(tmp)
    ...
    print("[ci-aggregate-age5-child-summary-gate0-transport-family-selftest] ok")
    return 0
