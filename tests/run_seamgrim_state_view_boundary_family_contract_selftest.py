...
SCRIPT_TAG = "seamgrim-state-view-boundary-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_STATE_VIEW_BOUNDARY_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("seamgrim_state_view_boundary_family", "tests/run_seamgrim_state_view_boundary_family_selftest.py"),
)
...
CONTRACT_PREREQ_COVERED_CHECKS = {
    ...
    "seamgrim_state_view_boundary_family",
}
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_state_view_boundary_family_contract_selftest.progress.v1",
