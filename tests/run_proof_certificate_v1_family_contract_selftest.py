...
SCRIPT_TAG = "proof-certificate-v1-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_PROOF_CERTIFICATE_V1_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("promotion", "tests/run_proof_certificate_v1_promotion_selftest.py"),
    ("family", "tests/run_proof_certificate_v1_family_selftest.py"),
)
