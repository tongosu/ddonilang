...
SCRIPT_TAG = "bogae-alias-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_BOGAE_ALIAS_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("shape_alias_contract", "tests/run_bogae_shape_alias_contract_selftest.py"),
    ("alias_family", "tests/run_bogae_alias_family_selftest.py"),
    ("alias_viewer_family", "tests/run_bogae_alias_viewer_family_selftest.py"),
)
