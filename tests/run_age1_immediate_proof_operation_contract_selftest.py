...
SCRIPT_TAG = "age1-immediate-proof-operation-contract-selftest"
PROGRESS_ENV_KEY = "DDN_AGE1_IMMEDIATE_PROOF_OPERATION_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("operation_matrix", "tests/run_age1_immediate_proof_operation_matrix_selftest.py"),
    ("solver_search_matrix", "tests/run_age1_immediate_proof_solver_search_matrix_selftest.py"),
    ("solver_search_parity", "tests/run_proof_solver_search_operation_parity_selftest.py"),
    ("solver_operation_family", "tests/run_proof_solver_operation_family_selftest.py"),
    ("proof_operation_family", "tests/run_proof_operation_family_selftest.py"),
)
