...
SCRIPT_TAG = "state-view-hash-separation-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_STATE_VIEW_HASH_SEPARATION_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("wasm_viewmeta_statehash", [sys.executable, "tests/run_seamgrim_wasm_smoke.py", "seamgrim_wasm_viewmeta_statehash_v1"]),
    ("state_hash_view_boundary", [sys.executable, "tests/run_pack_golden.py", "seamgrim_state_hash_view_boundary_smoke_v1"]),
    ("wasm_bridge_contract", [sys.executable, "tests/run_seamgrim_wasm_smoke.py", "seamgrim_wasm_bridge_contract_v1"]),
    ("seamgrim_bridge_family", [sys.executable, "tests/run_seamgrim_bridge_family_selftest.py"]),
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.state_view_hash_separation_family_contract_selftest.progress.v1",
