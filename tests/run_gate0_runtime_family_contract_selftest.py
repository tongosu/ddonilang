...
SCRIPT_TAG = "gate0-runtime-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_GATE0_RUNTIME_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("lang_runtime_family", "tests/run_lang_runtime_family_selftest.py"),
    ("w95_cert", "tests/run_w95_cert_pack_check.py"),
    ("w96_somssi", "tests/run_w96_somssi_pack_check.py"),
    ("w97_self_heal", "tests/run_w97_self_heal_pack_check.py"),
