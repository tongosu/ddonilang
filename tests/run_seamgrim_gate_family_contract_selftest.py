...
SCRIPT_TAG = "seamgrim-gate-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_GATE_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_gate_family_contract_selftest.progress.v1",
