...
def main() -> int:
    ...
    if not bool(payload.get("ok")):
        print(
            "check=seamgrim_generic_imja_same_kind_no_reentry_raw_wasm "
    ...
    if not str(payload.get("state_hash", "")).strip():
        print("check=seamgrim_generic_imja_same_kind_no_reentry_raw_wasm detail=missing_hash")
        return 1
    ...
    if seq != "1323":
        ...
        return 1
    print("seamgrim generic imja same kind no reentry raw wasm check ok seq=1323")
    return 0
