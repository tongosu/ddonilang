...
SCRIPT_TAG = "lang-runtime-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_lang_runtime_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_LANG_RUNTIME_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_lang_runtime_family_contract_selftest.py"),
    ("aggregate_preview_summary", "tests/run_ci_aggregate_age5_child_summary_lang_runtime_family_transport_selftest.py"),
