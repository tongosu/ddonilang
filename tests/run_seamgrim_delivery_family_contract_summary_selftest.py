...
from run_seamgrim_delivery_family_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-delivery-family-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-delivery-family-contract-summary-selftest] ok")
    return 0
