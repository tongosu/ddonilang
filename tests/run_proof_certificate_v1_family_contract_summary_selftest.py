...
from run_proof_certificate_v1_family_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[proof-certificate-v1-family-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[proof-certificate-v1-family-contract-summary-selftest] ok")
    return 0
