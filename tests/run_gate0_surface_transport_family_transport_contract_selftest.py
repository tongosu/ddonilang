...
SCRIPT_TAG = "gate0-surface-transport-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_gate0_surface_transport_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_GATE0_SURFACE_TRANSPORT_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_gate0_surface_transport_family_contract_selftest.py"),
    ("lang_surface_transport", "tests/run_lang_surface_family_transport_contract_selftest.py"),
    ("lang_runtime_transport", "tests/run_lang_runtime_family_transport_contract_selftest.py"),
    ("gate0_runtime_transport", "tests/run_gate0_runtime_family_transport_contract_selftest.py"),
    ("gate0_family_transport", "tests/run_gate0_family_transport_contract_selftest.py"),
    ("gate0_transport_family_transport", "tests/run_gate0_transport_family_transport_contract_selftest.py"),
    ("gate0_surface_family_transport", "tests/run_gate0_surface_family_transport_contract_selftest.py"),
)
