...
const OK = "seamgrim_numeric_track_result_timeline_view: ok";
...
async function main() {
  ...
  try {
    ...
    await page.waitForSelector("#numeric-track-result-timeline-panel:not(.hidden) .numeric-track-timeline-row");
