...
REQUIRED_EMIT_SELFTEST_TOKENS = [
    ...
    "broken_sanity_product_blocker_step_missing",
    "broken_sanity_product_blocker_step_failed",
    "badsanityproductblockermissing",
    "badsanityproductblockerfailed",
    "broken_sanity_observe_output_contract_step_missing",
    "broken_sanity_observe_output_contract_step_failed",
    "badsanityobserveoutputmissing",
    "badsanityobserveoutputfailed",
    "broken_sanity_runtime_view_source_strict_step_missing",
    "broken_sanity_runtime_view_source_strict_step_failed",
    "badsanityviewsourcestrictmissing",
    "badsanityviewsourcestrictfailed",
    "broken_sanity_run_legacy_autofix_step_missing",
    "broken_sanity_run_legacy_autofix_step_failed",
    "badsanitylegacyautofixmissing",
    "badsanitylegacyautofixfailed",
