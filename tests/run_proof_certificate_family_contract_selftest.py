...
SCRIPT_TAG = "proof-certificate-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_PROOF_CERTIFICATE_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("artifact_certificate_contract", "tests/run_proof_artifact_certificate_contract_selftest.py"),
    ("proof_certificate_v1_family", "tests/run_proof_certificate_v1_family_selftest.py"),
    ("proof_certificate_family", "tests/run_proof_certificate_family_selftest.py"),
)
