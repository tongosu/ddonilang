...
README_PATH = Path("tests/seamgrim_interaction_family/README.md")
...
def fail(message: str) -> int:
    print(f"[seamgrim-interaction-family-selftest] fail: {message}")
    return 1
...
def main() -> int:
    try:
        ...
        ensure_snippets(
            SEAMGRIM_GATE,
            (
                '"seamgrim_interaction_family_selftest"',
                '[py, "tests/run_seamgrim_interaction_family_selftest.py"]',
                '"seamgrim_interaction_family_contract_selftest"',
                '[py, "tests/run_seamgrim_interaction_family_contract_selftest.py"]',
                '"seamgrim_interaction_family_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_interaction_family_contract_summary_selftest.py"]',
                '"seamgrim_interaction_family_transport_contract_selftest"',
                '[py, "tests/run_seamgrim_interaction_family_transport_contract_selftest.py"]',
                '"seamgrim_interaction_family_transport_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_interaction_family_transport_contract_summary_selftest.py"]',
            ),
        )
    except ValueError as exc:
        return fail(str(exc))
    print("[seamgrim-interaction-family-selftest] ok lines=1")
    return 0
