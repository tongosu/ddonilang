...
def fail(msg: str) -> int:
    print(f"[ci-aggregate-age5-child-summary-age1-immediate-proof-operation-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(
        prefix="ci_aggregate_age5_child_summary_age1_immediate_proof_operation_selftest_"
    ) as tmp:
        work = Path(tmp)
    ...
    print("[ci-aggregate-age5-child-summary-age1-immediate-proof-operation-selftest] ok")
    return 0
