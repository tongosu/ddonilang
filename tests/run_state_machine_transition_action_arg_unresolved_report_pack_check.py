...
def fail(detail: str) -> int:
    print(f"check=state_machine_transition_action_arg_unresolved_report_pack detail={detail}")
    return 1
...
def main() -> int:
    ...
    print("state machine transition action arg unresolved report pack check ok")
    return 0
