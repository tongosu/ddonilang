...
from run_seamgrim_surface_family_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-surface-family-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-surface-family-contract-summary-selftest] ok")
    return 0
