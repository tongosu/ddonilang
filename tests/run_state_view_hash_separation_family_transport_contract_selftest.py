...
SCRIPT_TAG = "state-view-hash-separation-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_state_view_hash_separation_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_STATE_VIEW_HASH_SEPARATION_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_state_view_hash_separation_family_contract_selftest.py"),
    ("wasm_viewmeta_statehash", "tests/run_seamgrim_wasm_smoke.py seamgrim_wasm_viewmeta_statehash_v1"),
    ("state_hash_view_boundary", "tests/run_pack_golden.py seamgrim_state_hash_view_boundary_smoke_v1"),
    ("wasm_bridge_contract", "tests/run_seamgrim_wasm_smoke.py seamgrim_wasm_bridge_contract_v1"),
    ("seamgrim_bridge_family", "tests/run_seamgrim_bridge_family_selftest.py"),
)
CHECKS_TEXT = ",".join(name for name, _ in CHECKS)
FAMILY_CONTRACT_NAME = "family_contract"
FAMILY_CONTRACT_COVERED_CHECKS = {
    "wasm_viewmeta_statehash",
    "state_hash_view_boundary",
    "wasm_bridge_contract",
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.state_view_hash_separation_family_transport_contract_selftest.progress.v1",
