...
SCRIPT_TAG = "seamgrim-bridge-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_bridge_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_BRIDGE_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_bridge_family_contract_selftest.py"),
    ("graph_bridge_contract", "tests/run_seamgrim_graph_bridge_contract_selftest.py"),
    ("bridge_hash_cross_check", "tests/run_seamgrim_bridge_check_selftest.py"),
    ("graph_api_parity", "tests/run_seamgrim_graph_api_parity_check_selftest.py"),
    ("bridge_surface_api_parity", "tests/run_seamgrim_bridge_surface_api_parity_check_selftest.py"),
    ("space2d_api_parity", "tests/run_seamgrim_space2d_api_parity_check_selftest.py"),
)
CHECKS_TEXT = ",".join(name for name, _ in CHECKS)
FAMILY_CONTRACT_NAME = "family_contract"
FAMILY_CONTRACT_COVERED_CHECKS = {
    "graph_bridge_contract",
    "bridge_hash_cross_check",
    "graph_api_parity",
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_bridge_family_transport_contract_selftest.progress.v1",
