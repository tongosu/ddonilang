...
SCRIPT_TAG = "seamgrim-consumer-surface-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_consumer_surface_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_CONSUMER_SURFACE_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_consumer_surface_family_contract_selftest.py"),
    ("workflow_contract", "tests/run_seamgrim_workflow_contract_check.py"),
    ("schema_gate", "tests/run_seamgrim_lesson_schema_gate.py"),
    ("visual_contract", "tests/run_seamgrim_visual_contract_check.py"),
    ("browse_selection_flow", "tests/run_seamgrim_browse_selection_flow_check.py"),
    ("state_view_boundary_transport", "tests/run_seamgrim_state_view_boundary_family_transport_contract_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_consumer_surface_family_transport_contract_selftest.progress.v1",
