...
def fail(msg: str) -> int:
    print(f"[ci-aggregate-age5-child-summary-w107-selftest] fail: {msg}")
    return 1
...
def persistent_tmpdir(prefix: str) -> Path:
...
def main() -> int:
    ...
    work = persistent_tmpdir(prefix="ci_aggregate_age5_child_summary_w107_selftest_")
    ...
    print("[ci-aggregate-age5-child-summary-w107-selftest] ok")
    return 0
