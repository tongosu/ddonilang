#!/usr/bin/env python3
"""Validate ROADMAP_V2_POST_HA1_FRONTIER_REBASE_V1."""
...
REPORT = ROOT / "docs" / "status" / "roadmap_v2" / "POST_HA1_FRONTIER_REBASE_REPORT_20260609.md"
DEV_SUMMARY = ROOT / "docs" / "context" / "all" / "DEV_SUMMARY.md"
PROJECT_STATUS = ROOT / "docs" / "status" / "PROJECT_STATUS.md"
CHANGELOG = ROOT / "docs" / "status" / "CHANGELOG.md"
MATRIX = ROOT / "docs" / "context" / "roadmap" / "ROADMAP_V2_GANADA_MILESTONE_MATRIX_20260426.md"
PACK = ROOT / "pack" / "roadmap_v2_post_ha1_frontier_rebase_v1"
CONTRACT = PACK / "contract.detjson"


def fail(message: str) -> None:
    print(f"[roadmap-v2-post-ha1-frontier-rebase] FAIL: {message}", file=sys.stderr)
    raise SystemExit(1)
...
def check_files_and_docs() -> None:
    for path in [
        ...
        PACK / "golden.jsonl",
        CONTRACT,
        ROOT / "tests" / "run_roadmap_v2_ha1_representative_teaching_smoke_check.py",
        ROOT / "docs" / "status" / "roadmap_v2" / "아-1_REPORT_20260604.md",
    ]:
        require_file(path)
    shared = [
        "ROADMAP_V2_POST_HA1_FRONTIER_REBASE_V1",
        "A1_NURIGYM_RESET_STEP_MATRIX_RECONCILIATION_V1",
        "ROADMAP_V2 post-HA1 frontier rebase 4/4 = 100%",
        ...
        "a1_matrix_reconciliation_claim:false",
        "docs_ssot_change:false",
    ]
    for path in [REPORT, DEV_SUMMARY]:
        require_tokens(path, shared)
    require_tokens(PROJECT_STATUS, ["ROADMAP_V2_POST_HA1_FRONTIER_REBASE_V1", "57/90 = 63%", "60/90 = 67%", "아-1"])
    require_tokens(CHANGELOG, ["ROADMAP_V2 post-HA1 frontier rebase", "A1_NURIGYM_RESET_STEP_MATRIX_RECONCILIATION_V1"])
...
def check_contract() -> None:
    ...
    expected = {
        ...
        "pack": "roadmap_v2_post_ha1_frontier_rebase_v1",
        "kind": "roadmap_v2_post_ha1_frontier_rebase",
        "runtime_claim": False,
        ...
        "selected_next_work": "A1_NURIGYM_RESET_STEP_MATRIX_RECONCILIATION_V1",
        "selected_coordinate": "아-1",
        "docs_ssot_change": False,
    }
...
def check_forbidden_claims() -> None:
    forbidden = [
        ...
        '"a1_matrix_reconciliation_claim": true',
...
def check_gates() -> None:
    run([sys.executable, "tests/run_pack_golden.py", "roadmap_v2_post_ha1_frontier_rebase_v1"], timeout=120)
    run([sys.executable, "tests/run_roadmap_v2_ha1_representative_teaching_smoke_check.py"], timeout=600)
...
def main() -> None:
    ...
    check_gates()
    print("[roadmap-v2-post-ha1-frontier-rebase] OK")
