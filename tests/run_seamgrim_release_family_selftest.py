...
README_PATH = Path("tests/seamgrim_release_family/README.md")
DELIVERY_README = Path("tests/seamgrim_delivery_family/README.md")
GATE_README = Path("tests/seamgrim_gate_family/README.md")
...
def fail(message: str) -> int:
    print(f"[seamgrim-release-family-selftest] fail: {message}")
    return 1
...
def main() -> int:
    try:
        ...
        ensure_pointers(DELIVERY_README)
        ensure_pointers(GATE_README)
        ensure_snippets(
            SEAMGRIM_GATE,
            (
                '"seamgrim_release_family_selftest"',
                '[py, "tests/run_seamgrim_release_family_selftest.py"]',
                '"seamgrim_release_family_contract_selftest"',
                '[py, "tests/run_seamgrim_release_family_contract_selftest.py"]',
                '"seamgrim_release_family_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_release_family_contract_summary_selftest.py"]',
                '"seamgrim_release_family_transport_contract_selftest"',
                '[py, "tests/run_seamgrim_release_family_transport_contract_selftest.py"]',
                '"seamgrim_release_family_transport_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_release_family_transport_contract_summary_selftest.py"]',
            ),
        )
    except ValueError as exc:
        return fail(str(exc))
    print("[seamgrim-release-family-selftest] ok lines=2")
    return 0
