...
async function main() {
  ...
  try {
    ...
    assert(state.chipText === "수치트랙: 근/구간", `numeric chip text mismatch: ${state.chipText}`);
    ...
    assert(state.runPreset?.numeric_track_label === "수치트랙: 근/구간", "run preset numeric label mismatch");
