...
from run_seamgrim_state_view_boundary_family_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-state-view-boundary-family-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-state-view-boundary-family-contract-summary-selftest] ok")
    return 0
