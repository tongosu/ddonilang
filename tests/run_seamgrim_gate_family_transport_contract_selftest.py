...
SCRIPT_TAG = "seamgrim-gate-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_gate_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_GATE_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_gate_family_contract_selftest.py"),
    ("runtime_transport", "tests/run_seamgrim_runtime_family_transport_contract_selftest.py"),
    ("group_id_summary", "tests/run_seamgrim_group_id_summary_check.py"),
    ("runtime_fallback_metrics", "tests/run_seamgrim_runtime_fallback_metrics_check.py"),
    ("runtime_fallback_policy", "tests/run_seamgrim_runtime_fallback_policy_check.py"),
    ("frontdoor_strict_all", "tests/run_seamgrim_frontdoor_strict_all_check.py"),
    ("subject_representative_examples", "tests/run_seamgrim_subject_representative_examples_check.py"),
...
FAMILY_CONTRACT_COVERED_CHECKS = {
    ...
    "subject_representative_examples",
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_gate_family_transport_contract_selftest.progress.v1",
