...
from run_bogae_alias_family_transport_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[bogae-alias-family-transport-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[bogae-alias-family-transport-contract-summary-selftest] ok")
    return 0
