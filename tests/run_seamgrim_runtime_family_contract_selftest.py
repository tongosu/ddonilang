...
SCRIPT_TAG = "seamgrim-runtime-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_RUNTIME_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("seamgrim_runtime_family", "tests/run_seamgrim_runtime_family_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_runtime_family_contract_selftest.progress.v1",
