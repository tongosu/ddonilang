...
SCRIPT_TAG = "seamgrim-total-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_TOTAL_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("system_transport", "tests/run_seamgrim_system_family_selftest.py"),
    ("full_gate", "tests/run_seamgrim_full_gate_check.py"),
    ("seamgrim_total_family", "tests/run_seamgrim_total_family_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_total_family_contract_selftest.progress.v1",
