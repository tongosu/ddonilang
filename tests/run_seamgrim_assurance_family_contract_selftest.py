...
SCRIPT_TAG = "seamgrim-assurance-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_ASSURANCE_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("seamgrim_assurance_family", "tests/run_seamgrim_assurance_family_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_assurance_family_contract_selftest.progress.v1",
