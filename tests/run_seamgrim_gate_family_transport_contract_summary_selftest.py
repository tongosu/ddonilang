...
from run_seamgrim_gate_family_transport_contract_selftest import CHECKS_TEXT
...
def fail(msg: str) -> int:
    print(f"[seamgrim-gate-family-transport-contract-summary-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    print("[seamgrim-gate-family-transport-contract-summary-selftest] ok")
    return 0
