...
SCRIPT_TAG = "gate0-transport-family-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_gate0_transport_family_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_GATE0_TRANSPORT_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("gate0_transport_family", "tests/run_gate0_transport_family_selftest.py"),
)
