...
SCRIPT_TAG = "bogae-alias-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_bogae_alias_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_BOGAE_ALIAS_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_bogae_alias_family_contract_selftest.py"),
    (
        "aggregate_preview_summary",
        "tests/run_ci_aggregate_age5_child_summary_bogae_alias_family_transport_contract_selftest.py",
    ),
