...
SCRIPT_TAG = "seamgrim-state-view-boundary-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_state_view_boundary_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_STATE_VIEW_BOUNDARY_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_state_view_boundary_family_contract_selftest.py"),
    ("bridge_family_transport", "tests/run_seamgrim_bridge_family_transport_contract_selftest.py"),
    ("state_view_hash_separation_transport", "tests/run_state_view_hash_separation_family_transport_contract_selftest.py"),
    ("view_hash_family_transport", "tests/run_seamgrim_view_hash_family_transport_contract_selftest.py"),
)
CHECKS_TEXT = ",".join(name for name, _ in CHECKS)
FAMILY_CONTRACT_NAME = "family_contract"
FAMILY_CONTRACT_COVERED_CHECKS = {
    "bridge_family_transport",
    "state_view_hash_separation_transport",
    "view_hash_family_transport",
}
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_state_view_boundary_family_transport_contract_selftest.progress.v1",
