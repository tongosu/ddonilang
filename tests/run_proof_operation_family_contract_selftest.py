...
SCRIPT_TAG = "proof-operation-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_PROOF_OPERATION_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("age1_solver_search_matrix", "tests/run_age1_immediate_proof_solver_search_matrix_selftest.py"),
