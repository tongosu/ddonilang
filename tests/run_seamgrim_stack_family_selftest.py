...
def fail(message: str) -> int:
    print(f"[seamgrim-stack-family-selftest] fail: {message}")
    return 1
...
def main() -> int:
    try:
        ...
        ensure_snippets(
            SEAMGRIM_GATE,
            (
                '"seamgrim_stack_family_selftest"',
                '[py, "tests/run_seamgrim_stack_family_selftest.py"]',
                '"seamgrim_stack_family_contract_selftest"',
                '[py, "tests/run_seamgrim_stack_family_contract_selftest.py"]',
                '"seamgrim_stack_family_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_stack_family_contract_summary_selftest.py"]',
                '"seamgrim_stack_family_transport_contract_selftest"',
                '[py, "tests/run_seamgrim_stack_family_transport_contract_selftest.py"]',
                '"seamgrim_stack_family_transport_contract_summary_selftest"',
                '[py, "tests/run_seamgrim_stack_family_transport_contract_summary_selftest.py"]',
            ),
        )
    except ValueError as exc:
        return fail(str(exc))
    print("[seamgrim-stack-family-selftest] ok lines=3")
    return 0
