...
SCRIPT_TAG = "seamgrim-assurance-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_assurance_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_ASSURANCE_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_assurance_family_contract_selftest.py"),
    ("total_transport", "tests/run_seamgrim_total_family_transport_contract_selftest.py"),
    ("guard_surface_transport", "tests/run_seamgrim_guard_surface_family_transport_contract_selftest.py"),
)
CHECKS_TEXT = ",".join(name for name, _ in CHECKS)
FAMILY_CONTRACT_NAME = "family_contract"
FAMILY_CONTRACT_COVERED_CHECKS = {
    "total_transport",
    "guard_surface_transport",
}
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_assurance_family_transport_contract_selftest.progress.v1",
