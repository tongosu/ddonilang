...
SCRIPT_TAG = "seamgrim-stack-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_stack_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_STACK_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_stack_family_contract_selftest.py"),
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_stack_family_transport_contract_selftest.progress.v1",
