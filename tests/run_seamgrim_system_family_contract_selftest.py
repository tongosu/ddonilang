...
SCRIPT_TAG = "seamgrim-system-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_SYSTEM_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ...
    ("seamgrim_system_family", "tests/run_seamgrim_system_family_selftest.py"),
)
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_system_family_contract_selftest.progress.v1",
