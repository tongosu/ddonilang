...
RUNNER = ROOT / "tests" / "seamgrim_numeric_track_run_result_link_runner.mjs"
NEXT = "SEAMGRIM_NUMERIC_TRACK_RESULT_HISTORY_FILTER_V1"


def fail(message: str) -> None:
    print(f"seamgrim_numeric_track_run_result_link_check: FAIL: {message}", file=sys.stderr)
    sys.exit(1)
...
def check_required_files() -> None:
    required = [
        ...
        ROOT / "tests" / "run_seamgrim_numeric_track_run_preset_check.py",
    ]
...
def check_docs() -> None:
    tokens = [
        ...
        "__SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK__",
        "__SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK_TEXT__",
        NEXT,
        "docs/ssot/**",
    ]
...
def check_product_tokens() -> None:
    ...
    require_contains(
        ...
        [
            "buildNumericTrackRunResultLink",
            "formatNumericTrackRunResultLinkText",
            "runResultNumericLinkEl",
            "syncNumericTrackRunResultLink",
            "__SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK__",
            "__SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK_TEXT__",
...
def check_contract() -> None:
    ...
    expected = {
        ...
        "kind": "studio_numeric_track_run_result_link",
        "runtime_claim": False,
        "product_code_change": True,
        "lesson_schema_change": False,
        "active_allowlist_mutation": False,
        "closed_by": "SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK_V1",
        "based_on": "SEAMGRIM_NUMERIC_TRACK_RUN_PRESET_V1",
        "browser_runner": "tests/seamgrim_numeric_track_run_result_link_runner.mjs",
    ...
    if not isinstance(covers, list) or "numeric_track_run_result_local_storage" not in covers:
        fail(f"contract covers missing local storage: {covers!r}")
...
def check_golden() -> None:
    ...
    expected = [
        "SEAMGRIM_NUMERIC_TRACK_RUN_RESULT_LINK_V1",
        "studio numeric track run result link sealed",
...
def run_required_gates() -> None:
    commands = [
        ["node", "tests/seamgrim_numeric_track_run_result_link_runner.mjs"],
        ["python", "tests/run_pack_golden.py", "seamgrim_numeric_track_run_result_link_v1"],
        ["python", "tests/run_seamgrim_numeric_track_run_preset_check.py"],
    ]
    for cmd in commands:
...
def main() -> None:
    ...
    print("seamgrim_numeric_track_run_result_link_check: ok")
