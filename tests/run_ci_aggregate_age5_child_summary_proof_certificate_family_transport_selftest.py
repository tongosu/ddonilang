...
def fail(msg: str) -> int:
    print(f"[ci-aggregate-age5-child-summary-proof-certificate-family-transport-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(
        prefix="ci_aggregate_age5_child_summary_proof_certificate_family_transport_selftest_"
    ) as tmp:
        work = Path(tmp)
    ...
    print("[ci-aggregate-age5-child-summary-proof-certificate-family-transport-selftest] ok")
    return 0
