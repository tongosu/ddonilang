...
def fail(msg: str) -> int:
    print(f"[ci-aggregate-age5-child-summary-lang-surface-family-transport-selftest] fail: {msg}")
    return 1
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(
        prefix="ci_aggregate_age5_child_summary_lang_surface_family_transport_selftest_"
    ) as tmp:
        work = Path(tmp)
    ...
    print("[ci-aggregate-age5-child-summary-lang-surface-family-transport-selftest] ok")
    return 0
