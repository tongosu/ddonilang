...
SCRIPT_TAG = "seamgrim-total-family-transport-contract-selftest"
SELF_SCRIPT_PATH = "tests/run_seamgrim_total_family_transport_contract_selftest.py"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_TOTAL_FAMILY_TRANSPORT_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
    ("family_contract", "tests/run_seamgrim_total_family_contract_selftest.py"),
    ("system_transport", "tests/run_seamgrim_system_family_selftest.py"),
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_total_family_transport_contract_selftest.progress.v1",
