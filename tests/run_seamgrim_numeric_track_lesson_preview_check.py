...
DOC = ROOT / "docs" / "context" / "queue" / "SEAMGRIM_NUMERIC_TRACK_LESSON_PREVIEW_V1.md"
PREV = ROOT / "docs" / "context" / "queue" / "SEAMGRIM_NUMERIC_TRACK_BROWSER_INDEX_V1.md"
...
def check_docs() -> None:
    ...
    require_contains(ROOT / "docs" / "context" / "queue" / "STUDIO_LONG_HORIZON_ROADMAP_V1.md", ["SEAMGRIM_NUMERIC_TRACK_LESSON_PREVIEW_V1", NEXT, "numeric track"])
