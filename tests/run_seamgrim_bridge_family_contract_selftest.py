...
SCRIPT_TAG = "seamgrim-bridge-family-contract-selftest"
PROGRESS_ENV_KEY = "DDN_SEAMGRIM_BRIDGE_FAMILY_CONTRACT_SELFTEST_PROGRESS_JSON"
CHECKS = (
...
def write_progress_snapshot(
    ...
    *,
    ...
    payload = {
        "schema": "ddn.ci.seamgrim_bridge_family_contract_selftest.progress.v1",
