...
def _write_bootstrap_progress() -> None:
    ...
    payload = {
        ...
        "status": "running",
        "current_stage": "bootstrap_imports",
...
def main() -> int:
    _write_bootstrap_progress()
    from _resolve_age5_combined_heavy_policy_bootstrap import main as bootstrap_main
